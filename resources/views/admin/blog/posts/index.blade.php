    ...
    <section class="section">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="float-right">
                    <form id="searchForm">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search Title" name="name" value="">
                ...
                <div class="float-right">
                    <div class="sidebar__widget-content" style="margin-right:10px;">
                        <select onchange="window.location.href = this.value;" class="form-control">
                            <option value="" selected disabled>Search Category</option>
                            @foreach ($categoryArticles as $categoryArticle)
                                <option value="{{ route('admin.blog.posts.category', $categoryArticle->slug) }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($model->is_published)
                                        {{ $model->published_at->format('D  F y') }}
                                    @else
